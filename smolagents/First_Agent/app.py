...
def security_header_auditor(url: str) -> str:
    ...
    try:
        ...
        # Build clean human readable report
...
agent = CodeAgent(
    ...
    verbosity_level=2,
    name="assistant",
    description="A helpful web-enabled assistant that can search, read webpages, check timezones, generate images, and audit website security headers.",
)
